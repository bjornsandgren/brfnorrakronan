...
public class CompleteBalanceSheetTest {
    ...
    public void complete() {
        ...
        assertEquals(BigDecimal.ONE, balanceSheet.assets().intangibleFixedAssets().closing().value());
        ...
        assertEquals(BigDecimal.ONE, balanceSheet.assets().tangibleFixedAssets().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.assets().financialFixedAssets().closing().value());

        //verifying total fixed assets
        assertEquals(new BigDecimal("3"), balanceSheet.assets().totalFixedAssets().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.assets().inventory().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.assets().receivables().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.assets().shortTermInvestments().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.assets().cashAndBank().closing().value());

        //verifying total current assets
        assertEquals(new BigDecimal("4"), balanceSheet.assets().totalCurrentAssets().closing().value());


        //verifying total assets
        assertEquals(new BigDecimal("7"), balanceSheet.assets().totalAssets().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.liabilitiesAndEquityCapital().equityCapital().closing().value());

        //verifying total equity capital
        assertEquals(new BigDecimal("1"), balanceSheet.liabilitiesAndEquityCapital().equityCapital().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.liabilitiesAndEquityCapital().untaxedReserves().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.liabilitiesAndEquityCapital().provisions().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.liabilitiesAndEquityCapital().longTermLiabilities().closing().value());
        ...
        balanceSheet = daybook.balanceSheet();
        assertEquals(BigDecimal.ONE, balanceSheet.liabilitiesAndEquityCapital().shortTermLiabilities().closing().value());

        //verifying total liabilities
        assertEquals(new BigDecimal("2"), balanceSheet.assets().totalLiabilities().closing().value());

        //verifying total liabilities and equity
        assertEquals(new BigDecimal("5"), balanceSheet.liabilitiesAndEquityCapital().totalLiabilitiesAndEquityCapital().closing().value());
    }
}